...
本仓库 8 篇核心文档已汇编为册子《**我思故我写 · 架构解析——七套核心系统的工程实现**》（arch-v1.3.0，约 4.8 万字，CC BY-SA 4.0）——母书《我思故我写》的姊妹卷：母书回答"为什么"，本册回答"怎么做"。
...
├── README.md
├── archive/                   # 归档（含 2026-09-04 撤销的仓级 STRUCTURE_GUIDE，规范已收编母书仓 typesetting/）
